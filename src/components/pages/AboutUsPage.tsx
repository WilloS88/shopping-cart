import { SwiperAboutUs } from "../section/SwiperAboutUs";
  ...
  return (
    <div>
      <div className="max-w-3xl md:mx-auto mx-5 my-8 p-6 bg-gray-100 rounded-lg shadow-lg">
        ...
        Roman Will started this journey over a decade ago with a simple goal: to
        provide the finest selection of firearms to like-minded individuals.
        What began as a small local shop has grown into a trusted name in the
        community, offering a wide range of products and unparalleled customer
        service. Join us in celebrating the art of precision and the spirit of
        adventure.
        </p>
      </div>
      <div className="ml-10">
